...
use thienthu1410\BehatHTMLFormatter\Renderer\Behat2Renderer ;
use thienthu1410\BehatHTMLFormatter\Renderer\TwigRenderer ;
use thienthu1410\BehatHTMLFormatter\Renderer\MinimalRenderer ;
...
class BaseRenderer
{
    ...
    public function renderBeforeTestcase($obj) {
        $print = array() ;
        foreach($this->rendererList as $name => $renderer) {
            $print[$name] = $renderer->renderBeforeTestcase($obj) ;
        }
        return $print ;
    }
    ...
    public function renderAfterTestcase($obj) {
        $print = array() ;
        foreach($this->rendererList as $name => $renderer) {
            $print[$name] = $renderer->renderAfterTestcase($obj) ;
        }
        return $print ;
    }
