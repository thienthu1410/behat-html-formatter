...
namespace thienthu1410\BehatHTMLFormatter\Renderer ;
...
class TwigRenderer
{
    ...
    public function renderAfterExercise($obj) {
        ...
        $print = $twig->render('index.html.twig',
            array(
                ...
                'failedTestcases' => $obj->getFailedTestcases(),
                'passedTestcases' => $obj->getPassedTestcases(),
                'failedUncountedTestcases' => $obj->getFailedUncountedTestcases(),
                'passedUncountedTestcases' => $obj->getPassedUncountedTestcases(),
                'failedScenarios' => $obj->getFailedScenarios(),
                'passedScenarios' => $obj->getPassedScenarios(),
                'failedUncountedScenarios' => $obj->getFailedUncountedScenarios(),
                'passedUncountedScenarios' => $obj->getPassedUncountedScenarios(),
    ...
    /**
     * Renders before a test case.
     *
     * @param object   : BehatHTMLFormatter object
     * @return string  : HTML generated
     */
    public function renderBeforeTestcase($obj) {
        return '' ;
    }

    /**
     * Renders after a test case.
     *
     * @param object   : BehatHTMLFormatter object
     * @return string  : HTML generated
     */
    public function renderAfterTestcase($obj) {
        return '' ;
    }
